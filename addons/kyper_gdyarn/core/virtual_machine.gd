...
var Value = load("res://addons/kyper_gdyarn/core/value.gd")
var YarnProgram = load("res://addons/kyper_gdyarn/core/program/program.gd")
var YarnNode = load("res://addons/kyper_gdyarn/core/program/yarn_node.gd")
var Instruction = load("res://addons/kyper_gdyarn/core/program/instruction.gd")
