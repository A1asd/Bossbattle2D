...
const YarnNode = preload("res://addons/kyper_gdyarn/core/program/yarn_node.gd")
const Instruction = preload("res://addons/kyper_gdyarn/core/program/instruction.gd")
const YarnProgram = preload("res://addons/kyper_gdyarn/core/program/program.gd")
const Operand = preload("res://addons/kyper_gdyarn/core/program/operand.gd")
